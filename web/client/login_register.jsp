...
<%
    // Hứng thông báo lỗi hoặc thành công từ Controller
...
<head>
    ...
    <title>CDG - Đăng nhập / Đăng ký</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/login_register.css?v=3">
</head>
<body>
